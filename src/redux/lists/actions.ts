import {
  ...
  DELETE_LIST,
  UPDATE_LIST,
  ADD_TASK, SET_TASK_TO_DELETE, UNSET_TASK_TO_DELETE, DELETE_TASK, SET_TASK_TO_EDIT, UNSET_TASK_TO_EDIT, UPDATE_TASK
} from "./types"

export function addList (list: List): ListsAction {
  return {
    type: ADD_LIST,
    payload: list
  }
...
export function getLists (): ListsAction {
  return {
    type: GET_LISTS
  }
}
